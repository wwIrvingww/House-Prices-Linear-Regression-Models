...
# Definir las variables cuantitativas y sus descripciones en español
variables_cuantitativas <- data.frame(
  ...
  `Descripción` = c("Pies lineales de calle conectada a la propiedad", "Tamaño del lote en pies cuadrados", 
                    ...
                    "Valor de características misceláneas"),
...
# Crear la tabla con kable y aplicar el estilo rayado
