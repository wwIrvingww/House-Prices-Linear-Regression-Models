...
El MSE tiene un valor de 3,131,943,354 en este caso el valor es bastante alto. SI sacamos la raíz cuadrada de este error se obtiene un total de error de 55,963.76, ósea casi $56,000.00 dólares. Esto indica que el modelo tiene dificultades para predecir con precisión los valores extremos de SalePrice, lo cual es común en modelos que no están diseñados específicamente para regresión, como es el caso de Naive Bayes.  
