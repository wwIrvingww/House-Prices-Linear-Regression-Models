...
ggplot(data, aes(x = OverallQual, y = SalePrice)) +
  geom_point(aes(color = OverallQual), alpha = 0.6) +  # Puntos semi-transparentes coloreados por OverallQual
  geom_smooth(method = "lm", se = TRUE, color = "red") +  # Línea de regresión lineal con intervalo de confianza
